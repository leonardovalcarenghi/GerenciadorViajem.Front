                        ...
                        <div className="card-body">
                            <div className="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <p className="card-text fs-4">{travels.filter((_) => _.NomeStatusViagem === "Reprovado").length}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <tbody>
                                            {travels.map((travel) => (
                                                <tr key={travel.idViagem} travel-id={travel.idViagem}>
                                                    ...
                                                    <td className="text-center">
                                                        <span
                                                            className={`badge rounded-pill ${TRAVEL_STATUS_COLOR[travel.NomeStatusViagem]
                                                                }`}
                                                        >
                                                    ...
                                                    <td className="text-center">
                                                        {travel.NomeStatusViagem === "Aprovado" && (
                                                            ...
                                                            >
                                                                <IconDownload size={18} className="me-1" />
                                                                Baixar PDF
                                                            </button>
                                                        )}
                                                    </td>
                                                    ...
                                                    <td className="text-end">
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                ...
                                                                {isAdmin &&
                                                                    travel.NomeStatusViagem !== "Aprovado" &&
                                                                    travel.NomeStatusViagem !== "Rejeitado" && (
                                                                        <li>
